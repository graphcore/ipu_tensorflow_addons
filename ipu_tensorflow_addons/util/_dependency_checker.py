...
def _check_ipu_keras_exists():
  spec = _get_module_spec("keras.ipu")
  _check_package_exists("Keras", spec)


def _check_ipu_keras_version():
  actual_version = _get_module_version("keras")
  expected_version = _dependency_versions.KERAS_VERSION
  _check_package_version("Keras", actual_version, expected_version)


def check_dependencies():
  _check_ipu_tensorflow_exists()
  _check_ipu_keras_exists()
  _check_ipu_tensorflow_version()
  _check_ipu_keras_version()
